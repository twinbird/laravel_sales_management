...
class StoreEstimateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
			...
			'details.*.quantity' => 'required_without:details.*.is_delete|nullable|numeric|min:1|max:99999',
			'details.*.unit_price' => 'required_without:details.*.is_delete|nullable|numeric|min:-99999|max:99999',
			'details.*.price' => 'required_without:details.*.is_delete|nullable|numeric|min:-99999|max:99999',
        ];
    }
