...
<div class="form-group">
	...
	<input type="phone" class="form-control form-control-sm" id="tel" name="tel" value="{{ old('tel', $profile->tel) }}">
</div>

<div class="form-group">
	<label for="fax">FAX</label>
	<input type="phone" class="form-control form-control-sm" id="fax" name="fax" value="{{ old('fax', $profile->fax) }}">
</div>
